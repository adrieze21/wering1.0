...
gdjs.New_32sceneCode.GDPlatformObjects1.createFrom(runtimeScene.getObjects("Platform"));
...
for(var i = 0, len = gdjs.New_32sceneCode.GDPlatformObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDPlatformObjects1[i].hide();
}
for(var i = 0, len = gdjs.New_32sceneCode.GDGoLeftObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDGoLeftObjects1[i].hide();
}
